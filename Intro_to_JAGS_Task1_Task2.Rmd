...
Looking at the plots 500 iterations seems to be a good burnin time. Keep in mind the plots are starting at 1000 because of the `n.adapt` from the `jags.model` 
...
```{r}
T.1.sim.prior <- window(T.1.sim, T.1.n.adapt + 500) #500 observations after n.adapt
```
...
I want the effective Size to be greater then 5000. 
```{r}
